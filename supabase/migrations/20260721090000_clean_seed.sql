-- Limpeza do seed: novos escritórios recebem apenas dados regulatórios REAIS
-- (CSTs, cClassTrib, marcos da reforma e legislação). Removidos do seed:
-- produtos de exemplo, eventos de calendário fictícios e fluxo modelo.
-- Clientes, tarefas, equipe, eventos, produtos e fluxos começam vazios.
...
as $$
begin
  -- CSTs do IBS/CBS (Informe Técnico 2025.002 — RFB)
  ...
  -- cClassTrib (os 3 primeiros dígitos coincidem com o CST)
  ...
  -- Marcos reais da reforma tributária (datas oficiais da transição)
