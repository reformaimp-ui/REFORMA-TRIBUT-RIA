 ...
 *
 * O modal é renderizado via portal em document.body: um ancestral da página
 * (app/(app)/template.tsx) anima `transform` com fill-mode "both", o que o
 * transforma no containing block de qualquer descendente position:fixed —
 * sem o portal, o modal fica posicionado relativo a essa div (mais alta que
 * a viewport) em vez da tela, aparecendo fora da área visível.
 */
